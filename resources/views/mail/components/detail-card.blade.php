            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="{{ $index > 0 ? 'border-top: 1px solid rgba(255,255,255,0.06); padding-top: 16px;' : 'padding-bottom: 16px;' }}">
                        ...
                        <p style="margin: 0; font-family: 'DM Sans', system-ui, sans-serif; font-size: 15px; color: #F3F0E7; line-height: 1.5; mso-line-height-rule: exactly;">{!! app(\App\Services\Mail\HtmlSanitizerService::class)->sanitizeSimple($item['value']) !!}</p>
                    </td>
                </tr>
                @endforeach
            </table>
